---
title: "エージェント委任の連鎖を追跡する立場の方へ"
---


オーケストレータがサブエージェントを呼び MCP 経由でツールを叩く構成で何かが起きたとき、変更可能でシステム間に分散したログとエージェントメモリの組み合わせから「誰が誰に何を許可したか」を追跡している——そんなマルチエージェント基盤のための整理です。
