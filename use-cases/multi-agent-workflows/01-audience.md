...
When something goes wrong in an orchestrator-to-sub-agent-to-tool (MCP) chain, you're left piecing together "who authorized whom for what" from mutable, fragmented logs and agent memory.
