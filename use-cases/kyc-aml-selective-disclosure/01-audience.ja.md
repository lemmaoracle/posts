---
title: "KYC コンプライアンスとデータ最小化を両立する部門へ"
---


「コンプライアンスのために共有する」と「データ最小化を求められる」が同じ規制の中で並走し、PII を越境させるたびに GDPR・改正個人情報保護法・各国データ保護法との整合を問い直している——そんな金融・暗号資産のコンプライアンス部門のための整理です。
