---
title: "AI エージェントに支出権限を委ねはじめた財務・ガバナンス部門へ"
---


SaaS 更新や調達発注、業務委託の決済を AI エージェントに任せ始め、支出上限や承認閾値をいまだプロンプトと社内ドキュメントで管理している——プロンプトインジェクションが起きてもエージェントが権限内で支払ったと示せずにいる部門のための整理です。
