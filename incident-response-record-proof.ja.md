...
<figure class="figure--diagram">
  <img src="/assets/figures/incident-response-record-fig1.ja.svg" alt="現場が対応記録を保存すると同時にその内容が秘密コード化されて照合レジストリに登録され、確認する側である本部の担当部門が、いまの記録から作ったコードで保存した時のコードと照合する流れ" />
  <figcaption>図1 対応記録を、中身を出さずに照合する</figcaption>
</figure>
